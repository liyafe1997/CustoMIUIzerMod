...
import org.strawing.customiuizermod.SharedPrefsProvider;
...
public class Helpers {
    ...
    public static final String modulePkg = "org.strawing.customiuizermod";
    ...
    public static void setMiuiTheme(Activity act, int overrideTheme, boolean noBackground) {
        ...
        if (themeResId == 0)
            themeResId = act.getResources().getIdentifier(isNightMode(act) ? "Theme.Dark" : "Theme.Light", "style", "miui");
    ...
    public static void setMiuiPrefItem(View item) {
        ...
        if (title != null && "header".equals(title.getTag())) {
            ...
            if (resIdSize != 0)
                title.setTextSize(TypedValue.COMPLEX_UNIT_PX, item.getResources().getDimensionPixelSize(resIdSize));
        }
    ...
    public static boolean isSPlus() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.R + 1;
    }

    public static boolean isTPlus() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.R + 2;
    }
...
//	}
    ...
    public static boolean isXposedInstallerInstalled(Context context) {
        ...
        for (String manager : xposedManagers)
            try {
...
//	}
    ...
    public static boolean launchActivity(Activity act, String pkg, String cmp, boolean silent) {
        ...
        try {
            ...
            if (!silent)
                Toast.makeText(act, R.string.various_hiddenfeatures_not_found, Toast.LENGTH_LONG).show();
            return false;
        }
    }
    ...
    public static String getActionName(Context context, String key) {
        try {
            ...
            if (resId != 0)
                ...
                switch (what) {
                    case 1:
                        return modRes.getString(R.string.array_global_toggle_wifi);
                    case 2:
                        return modRes.getString(R.string.array_global_toggle_bt);
                    case 3:
                        return modRes.getString(R.string.array_global_toggle_gps);
                    case 4:
                        return modRes.getString(R.string.array_global_toggle_nfc);
                    case 5:
                        return modRes.getString(R.string.array_global_toggle_sound);
                    case 6:
                        return modRes.getString(R.string.array_global_toggle_brightness);
                    case 7:
                        return modRes.getString(R.string.array_global_toggle_rotation);
                    case 8:
                        return modRes.getString(R.string.array_global_toggle_torch);
                    case 9:
                        return modRes.getString(R.string.array_global_toggle_mobiledata);
                    default:
                        return null;
                }
            } else if (action == 20) {
    ...
    public static Pair<String, String> getActionNameLocal(Context context, String key) {
        try {
            ...
            if (resId != 0)
                ...
                switch (what) {
                    case 1:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_wifi));
                        break;
                    case 2:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_bt));
                        break;
                    case 3:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_gps));
                        break;
                    case 4:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_nfc));
                        break;
                    case 5:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_sound));
                        break;
                    case 6:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_brightness));
                        break;
                    case 7:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_rotation));
                        break;
                    case 8:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_torch));
                        break;
                    case 9:
                        pair = new Pair<>(toggle, modRes.getString(R.string.array_global_toggle_mobiledata));
                        break;
                }
            } else if (action == 20) {
    ...
    public static void performCustomVibration(Context context, int vibration, String ownPattern) {
        ...
        switch (vibration) {
            ...
            case 3:
                ...
                break;
            case 4:
                pattern = new long[]{0, 250, 150, 125, 100, 125};
                break;
            case 5:
                pattern = new long[]{0, 150, 150, 100, 250, 150, 150, 100};
                break;
            case 6:
                pattern = new long[]{0, 100, 150, 100, 150, 100};
                break;
            case 7:
