...
import org.strawing.customiuizermod.GateWaySettings;
...
//	public static FloatingSelector floatSel = null;
	public static final String ACTION_PREFIX = "org.strawing.customiuizermod.mods.action.";
	public static final String EVENT_PREFIX = "org.strawing.customiuizermod.mods.event.";
				...
				Helpers.findAndHookMethodSilently(Thread.getDefaultUncaughtExceptionHandler().getClass(), "uncaughtException", Thread.class, Throwable.class, new MethodHook() {
					...
					protected void before(MethodHookParam param) throws Throwable {
						if (param.args[1] != null) try {
							Intent intent = new Intent("org.strawing.customiuizermod.SAVEEXCEPTION");
